<template>
	...
	<view class="authorization">
		<view class="container" v-if="isBindUser || client_env==='web' || client_env==='app'">
			...
			<view v-if="!isaccredit &&(client_env==='wxh5' || client_env==='wxmp') " class="cu-modal" :class="modalName=='DialogModal1'?'show':''">
				<view class="cu-dialog">
					<view class="cu-bar bg-white justify-end">
						<view class="content">您还未授权登录，部分功能将不能使用，是否重新授权？</view>
					...
					<view class="cu-bar bg-white justify-end">
						<view class="action">
							...
							<button class="cu-btn bg-green margin-left" open-type="getUserInfo" @tap="hideModal">确定</button>			
						</view>
					</view>
				</view>
			</view>
