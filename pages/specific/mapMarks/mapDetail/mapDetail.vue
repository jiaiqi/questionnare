  ...
  <view class="content">
    ...
    <view class="jobsS">
      ...
      <view class="" style="display: flex;justify-content: space-between; flex-wrap: wrap;">
        <view class="listto" style="" v-for="(iten, index) in jobdata" :key="iten">
    ...
    <view class="qiun-charts">
      <view class="titlebar">
        <text @click="shopmarkt(index)" :class="index == idx ? 'titltcolr' : ''" v-for="(item, index) in title" :key="item">{{ item }}</text>
      </view>
