<template>
	<view class="cu-card article bg-blue" style="min-height: 100vh;">
		<view class="cu-item shadow" style="padding: 10upx;">
			...
			<view class="content" style="padding: 0 30upx;">
				<view class="desc">
					<view class="text-content-text text-black">
						<view v-html="JSON.parse(JSON.stringify(formData.remark).replace(/\<img/gi, '<img width=100% height=100%   '))"></view>
					</view>
			...
			<view class="button-box" style="margin: 30upx;" v-if="formType === 'detail' && configCols && configCols.length > 0 && formData.info_collect_type === '评估'">
